...
\begin{enumerate}
    ...
    \item \textbf{Formal verification}: Critical security properties are verified with 649 machine-checked theorems in Lean~4~\cite{paraxiom2026lean4}, with zero unresolved assumptions.
\end{enumerate}
...
S. Cormier,
``649 Lean 4 Theorems: Formal Verification Across Eight Post-Quantum Systems,''
